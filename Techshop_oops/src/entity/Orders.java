...
public class Orders {
	...
	public Orders(Customers customer2, LocalDate now, int count, List<OrderDetails> orderDetailsList) {
		...
		public Orders(Customers customer, LocalDateTime orderDate, double totalAmount, String status) {
	...
	public Orders(int orderId, LocalDateTime orderDate, double totalAmount, String status) {
