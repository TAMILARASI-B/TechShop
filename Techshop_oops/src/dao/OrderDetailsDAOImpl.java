...
public class OrderDetailsDAOImpl implements OrderDetailsDAO {
    ...
    @Override
    public void addOrderDetail(OrderDetails orderDetail) throws InsufficientStockException, IOException {
    ...
    @Override
    public void updateOrderDetailQuantity(int orderDetailID, int newQuantity) throws InsufficientStockException, IOException {
