...
VALUES (114, 'Rahul', 'Sharma', 'rahul.sharma@gmail.com', '9876543211', '5/10 XYZ Colony, Bangalore, 560001');
...
UPDATE Customers SET Email = 'banu01@gmail.com', Address = '12/23 HJO Colony,Trichy,621014'
...
JOIN Products p ON od.ProductID = p.ProductID WHERE od.OrderID = Orders.OrderID);
SELECT * FROM Orders;
...
UPDATE Orders SET Status = 'Shipped' WHERE OrderID IN(2,5,7);
SELECT * FROM Orders;
...
UPDATE Customers SET TotalOrders = (SELECT COUNT(*) FROM Orders
WHERE Orders.CustomerID = Customers.CustomerID);
SELECT CustomerID,CONCAT(FirstName, ' ', LastName) AS CustomerName,TotalOrders FROM Customers;